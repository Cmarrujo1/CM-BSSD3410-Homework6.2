# https://github.com/DKarandikar/Flocking/blob/master/Flocking/Flocking.py
# accessed on 9/19/24
# author : Daniel
#CHANGE LOG: 
# -*- coding: utf-8 -*-
...
class Flocking(tk.Tk):
    ...
    def create_buttons(self):
        ...
        self.obs_button = tk.Checkbutton(self.buttons,
                                         text="Use Obstacles",
                                         variable=self.useobs,
                                         width=18, onvalue=True, offvalue=False)
    ...
    def draw_boids(self):
        '''Draws boids onto canvas with trails'''
        for boid in self.world.boids:
            # Draw trail as a small circle
            self.canvas.create_oval(boid.pos_x - 2, boid.pos_y - 2, boid.pos_x + 2, boid.pos_y + 2, fill="blue",
                                    outline="")
...
if __name__ == "__main__":
    APP = Flocking(width=500, height=500)
    APP.mainloop()
    APP.quit()